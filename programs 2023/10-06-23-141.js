...
function deal(n) {
  ...
  while (deck.length > 0) {
    state = (state * 214013 + 2531011) % Math.pow(2, 31);
    const randomValue = Math.floor(state / Math.pow(2, 16));
    const cardIndex = randomValue % deck.length;
    const dealtCard = deck[cardIndex];
